...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="container-fluid r-aside">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex no-block">
                                    <div class="m-r-20 align-self-center"><span class="lstick m-r-20"></span><img src="<?php echo base_url('')?>assets/images/icon/income.png" alt="Income" /></div>
                                    <div class="align-self-center">
                                        <h6 class="text-muted m-t-10 m-b-0">Daily Sales</h6>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex no-block">
                                    <div class="m-r-20 align-self-center"><span class="lstick m-r-20"></span><img src="<?php echo base_url('')?>assets/images/icon/expense.png" alt="Income" /></div>
                                    <div class="align-self-center">
                                        <h6 class="text-muted m-t-10 m-b-0">Monthly Sales</h6>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex no-block">
                                    <div class="m-r-20 align-self-center"><span class="lstick m-r-20"></span><img src="<?php echo base_url('')?>assets/images/icon/assets.png" alt="Income" /></div>
                                    <div class="align-self-center">
                                        <h6 class="text-muted m-t-10 m-b-0">Monthly Transaction</h6>
                            ...
                            <div class="activity-box">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="activity-item">
                                        <div class="round m-r-20"><img src="<?php echo base_url('')?>assets/images/users/2.jpg" alt="user" width="50" /></div>
                                        <div class="m-t-10">
                                            ...
                                            <table class="table vm b-0 m-b-0">
                                                <tr>
                                                    <td class="m-r-10 b-0"><img src="<?php echo base_url('')?>assets/images/icon/zip.png" alt="user" /></td>
                                                    <td class="b-0">
                                    ...
                                    <!-- Activity item-->
                                    <div class="activity-item">
                                        <div class="round m-r-20"><img src="<?php echo base_url('')?>assets/images/users/3.jpg" alt="user" width="50" /></div>
                                        <div class="m-t-10">
                                            ...
                                            <span class="image-list m-t-10">
                                                <a href="javascript:void(0)"><img src="<?php echo base_url('')?>assets/images/users/1.jpg" class="img-circle" alt="user" width="40" /></a>
                                                <a href="javascript:void(0)"><img src="<?php echo base_url('')?>assets/images/users/4.jpg" class="img-circle" alt="user" width="40" /></a>
                                                <a href="javascript:void(0)"><img src="<?php echo base_url('')?>assets/images/users/5.jpg" class="img-circle" alt="user" width="40" /></a>
                                                <a href="javascript:void(0)"><img src="<?php echo base_url('')?>assets/images/users/6.jpg" class="img-circle" alt="user" width="40" /></a>
                                ...
                                <div class="card-body">
                                    <!-- Activity item-->
                                    <div class="activity-item">
                                        <div class="round m-r-20"><img src="<?php echo base_url('')?>assets/images/users/4.jpg" alt="user" width="50" /></div>
                                        <div class="m-t-10">
                                            <h5 class="m-b-0 font-medium">David R. Jones  <span class="text-muted font-14 m-l-10">| &nbsp; 6:30 PM</span></h5>
                                            <h6 class="text-muted">uploaded this file </h6>
                                            <span>
                                                <a href="javascript:void(0)" class="m-r-10"><img src="<?php echo base_url('')?>assets/images/big/img1.jpg" alt="user" width="60"></a>
                                                <a href="javascript:void(0)" class="m-r-10"><img src="<?php echo base_url('')?>assets/images/big/img2.jpg" alt="user" width="60"></a>
                                                <a href="javascript:void(0)" class="m-r-10"><img src="<?php echo base_url('')?>assets/images/big/img3.jpg" alt="user" width="60"></a>
                                            </span>
                                        </div>
                                    </div>
                                    <!-- Activity item-->
                                    <!-- Activity item-->
                                    <div class="activity-item">
                                        <div class="round m-r-20"><img src="<?php echo base_url('')?>assets/images/users/6.jpg" alt="user" width="50" /></div>
                                        <div class="m-t-10">
                                    ...
                                    <!-- Activity item-->
                                    <div class="activity-item">
                                        <div class="round m-r-20"><img src="<?php echo base_url('')?>assets/images/users/7.jpg" alt="user" width="50" /></div>
                                        <div class="m-t-10">
                                            <h5 class="m-b-0 font-medium">David R. Jones  <span class="text-muted font-14 m-l-10">| &nbsp; 6:30 PM</span></h5>
                                            <h6 class="text-muted">uploaded this file </h6>
                                            <p>It has survived not only five centuries</p>
                                            <span>
                                                <a href="javascript:void(0)" class="m-r-10"><img src="<?php echo base_url('')?>assets/images/big/img5.jpg" alt="user" width="60"></a>
                                                <a href="javascript:void(0)" class="m-r-10"><img src="<?php echo base_url('')?>assets/images/big/img6.jpg" alt="user" width="60"></a>
                                                <a href="javascript:void(0)" class="m-r-10"><img src="<?php echo base_url('')?>assets/images/big/img4.jpg" alt="user" width="60"></a>
                                            </span>
                                        </div>
                                    </div>
                                    <!-- Activity item-->
                    ...
                    <div class="col-lg-5 col-xlg-4">
                        <div class="card">
                            <div class="card-body little-profile text-center">
                                <div class="pro-img m-t-20"><img src="<?php echo base_url('')?>assets/images/users/4.jpg" alt="user"></div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><span class="lstick"></span>First Time Customers</h4>
                                <div id="new_customer" style="height:290px; width:100%;"></div>
                                <table class="table vm font-14">
                                    <tr>
                                        <td class="b-0">With Package</td>
                                        <td class="text-right font-medium b-0">21.5%</td>
                                    </tr>
                                    <tr>
                                        <td>Others</td>
                                        <td class="text-right font-medium">78.5%</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <aside class="right-side-panel">
                    <div class="row">
                        ...
                        <div class="col-md-12 m-t-10">
                            <h5 class="text-muted m-b-0">Skudai, Johor</h5>
                            ...
                            <div class="msg-widget m-t-20">
                                ...
                                <div class="msg-item">
                                    ...
                                    <div class="m-t-20 d-flex">
                                        <div class="m-pic m-r-20"><img src="<?php echo base_url('')?>assets/images/users/profile.png" alt="user"></div>
                                        <div class="author">
                                ...
                                <div class="msg-item">
                                    ...
                                    <div class="m-t-20 d-flex">
                                        <div class="m-pic m-r-20"><img src="<?php echo base_url('')?>assets/images/users/4.jpg" alt="user"></div>
                                        <div class="author">
                                            <h5 class="m-b-0">Mark Freeman</h5>
                                            <p class="text-muted font-14">Today 04:12 PM</p>
                                        </div>
                                ...
                                <div class="msg-item">
                                    ...
                                    <div class="m-t-20 d-flex">
                                        <div class="m-pic m-r-20"><img src="<?php echo base_url('')?>assets/images/users/2.jpg" alt="user"></div>
                                        <div class="author">
                                            <h5 class="m-b-0">Mark Freeman</h5>
                                            <p class="text-muted font-14">Today 04:12 PM</p>
                                        </div>
    ...
    <!-- Chart JS -->
    <script src="<?php echo base_url('assets/minimal/js/dashboard1.js')?>"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
